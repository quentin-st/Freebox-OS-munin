...
def print_config():
    ...
    if mode == mode_traffic:
        ...
        print('graph_title bits/s up/down')
        print('graph_vlabel bits in (-) / out (+) per second')
        print('bits_down.type COUNTER')
        print('bits_down.label bits/s')
        print('bits_down.graph no')
        print('bits_up.label bits/s')
        print('bits_up.type COUNTER')
        print('bits_up.negative bits_down')
    elif mode == mode_ftth:
